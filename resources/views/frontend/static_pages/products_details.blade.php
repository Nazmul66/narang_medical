...
<title>Baby Care Equipment, Newborn Baby Care Equipment, Infant Care Neonatal Equipments, Baby Care Equipments manufacturer, Neonatal Equipment Suppliers</title>
...
<header id="header">
  ...
  Breadcrumb Section
  ============================-->
     <div class="breadcrumb-image-test"><img src="{{ asset('public/frontend/images/banner/infant-care-baby-care-equipments-banner.jpg') }}" alt="infant care-baby care equipments"></div>
 ...
 <section>
  ...
  <section class="pt-40">
  	<div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h5 class="section-title">Infant Care & Baby Care Equipments</h5>
                <p class="section-description">We at Narang are aware of how important quality and efficiency is when it comes to infant and baby care equipments. A variety of infant and baby care equipments including diagnostic and therapeutic are available with us. NET brand Baby Incubator, Infant Radiant Warmer, Foetal Heart Monitor/Doppler, Infant Resuscitation Trolley, Baby Bassinet, Phototherapy Units, Infantometers, Ultra Voilet Sterilizers and Thermal Blankets are popular and exported across the globe.</p>
            </div>
            <!-- Watch Video -->
            <a href="https://www.youtube.com/embed/valdY_Jy-4Q?autoplay=1&cc_load_policy=1&fs=1&modestbranding=1&rel=0&autohide=1" class="btn-narang-outline iframe"  style="margin:0 auto;" ><i class="fas fa-video"></i>   Watch Video</a>
...
<section class="footers-top mt-80">
  <div class="container">
      <div class="row ">
          <div class="col-md-12">
              <small>
                 <p>Infant Care/Baby Care Equipments- Manufacturer of Baby Care Equipdr, Neonatal Equipments for Newborn Baby / Infants. Trust NET brand for Surgical Instruments, Medical Supplies, Hospital Equipments, Laboratory Products & Goods.</p>
             </small>
          </div>
      </div>
  </div>
...
<section>
      <div class="container-fluid">
        ...
        <h1 class="footers-tag-text">Baby Care Equipment</h1>
        <h2 class="footers-tag-text">Newborn Baby Care Equipment</h2>
        <h3 class="footers-tag-text">Infant Care Neonatal Equipments</h3>
