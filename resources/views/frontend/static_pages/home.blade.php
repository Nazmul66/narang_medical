...
<div class="sharethis-inline-share-buttons"></div>
  ...
  <section id="hero">
    ...
    <div class="hero-logo">
      <img class="img-fluid" src="{{ asset('public/frontend/images/logo.png') }}" alt="Manufacturer and suppliers of medical equipment, hospital equipment and supplies including hospital furniture, orthopedic implants, medical disposables, diagnostic equipment and other medical equipment." style="padding-top: 10px;">
    </div>
    </div>
    ...
    <div>
      <ul class="list-inline header-circle">
        <li class="list-inline-item">
          <div class="counter">
          <p style="font-size: 2rem; margin-bottom:0.1rem;"><span class="timer count-title count-number" data-to="80" data-speed="4500"></span>+</p>
          <p class="count-text">Years of Excellence</p>
        </div>
        </li>
        <li class="list-inline-item">
          <div class="counter">
          <p style="font-size: 2rem; margin-bottom:0.1rem;"><span class="timer count-title count-number" data-to="19" data-speed="4500"></span>k+</p>
          <p class="count-text">Medical Products</p>
        </div>
        </li>
        <li class="list-inline-item">
          <div class="counter">
          <p style="font-size: 2rem; margin-bottom:0.1rem;"><span class="timer count-title count-number" data-to="100" data-speed="4500" ></span>%</p>
  ...
  <section class="pt-80">
    <div class="container">
      ...
      <div class="row">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/hospital-medical-furniture.jpg') }}" class="image img-fluid" alt="Hospital Furniture">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Hospital Furniture</h5>
            <p>Hospital furniture along with modern medical equipment have......</p>
        ...
        <p><a href="hospital-medical-furniture/index.php">Hospital Furniture</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/orthopedic-implants-manufacturers-india.jpg') }}" class="image img-fluid" alt="Orthopedic Implants">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Orthopedic Implants</h5>
            <p>NET brand Orthopedic Implants and Instruments are being used...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="orthopedic-implants-manufacturers-india/index.php">Orthopedic Implants</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/medical-disposables.jpg') }}" class="image img-fluid" alt="Medical Disposables">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Medical Disposables</h5>
            <p>Designed to minimize patient discomfort and distress...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="medical-disposables/index.php">Medical Disposables</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/diagnostic_equipments.jpg') }}" class="image img-fluid" alt="Diagnostic Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Diagnostic Equipments</h5>
            <p>A correct diagnosis leads to correct treatment...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="diagnostic-equipments-products/index.php">Diagnostic Equipments</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/anaesthesia-equipments-products.jpg') }}" class="image img-fluid" alt="Anaesthesia Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Anaesthesia Equipments</h5>
            <p>An anesthesiologist, who is a specialist in Perioperative Medicine...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="anaesthesia-equipments-products/index.php">Anaesthesia Equipments</a></p>
        </div>
    </div>
...
<div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/autoclave-sterilizers.jpg') }}" class="image img-fluid" alt="Autoclave &amp; Sterilizers">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Autoclave &amp; Sterilizers</h5>
            <p>Each instrument or piece of medical equipment which comes...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="autoclave-sterilizers/index.php">Autoclave &amp; Sterilizers</a></p>
        </div>
    </div>
...
<div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/laboratory-products.jpg') }}" class="image img-fluid" alt="Laboratory Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Laboratory Products</h5>
            <p>NET brand Laboratory Products are dependable, durable...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="laboratory-products/index.php">Laboratory Products</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/height_weight_scales.jpg') }}" class="image img-fluid" alt="Height &amp; Weight Scales">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Height &amp; Weight Scales</h5>
            <p>We offer a variety of equipment and tools used for Anthropometric...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="height-weight-scales/index.php">Height &amp; Weight Scales</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/ob-gyn-gynecological-products.jpg') }}" class="image img-fluid" alt="OB GYN Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>OB GYN Products</h5>
            <p>Abortion Sets, Manual &amp; Electric Vacuum Extractor Sets...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="ob-gyn-gynecological-products/index.php">OB GYN Products</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/operation-theatre-lights.jpg') }}" class="image img-fluid" alt="OT &amp; Examination Lights">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>OT &amp; Examination Lights</h5>
            <p>Narang Medical provides ideal Operating Lighting equipment...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="operation-theatre-lights/index.php">OT &amp; Examination Lights</a></p>
        </div>
    </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        <div class="portfolio-item-new">
        <a href="suction-machines-units/index.php">
        <img src="{{ asset('public/frontend/images/thumbnails/suction-machines-units.jpg') }}" class="image img-fluid" alt="Suction Machines">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Suction Machines</h5>
            <p>NET brand Suction Machines, over the years has become...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="suction-machines-units/index.php">Suction Machines</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="images/thumbnails/medical-rubber-products.jpg" class="image img-fluid" alt="Medical Rubber Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Medical Rubber Products</h5>
            <p>Our Medical rubber products made from virgin natural rubber...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="medical-rubber-products/index.php">Medical Rubber Products</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/hospital-holloware.jpg') }}" class="image img-fluid" alt="Hospital Holloware">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Hospital Holloware</h5>
            <p>During medical procedures, surgery and even for patient care...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="hospital-holloware/index.php">Hospital Holloware</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/infant-baby-care-equipments.jpg') }}" class="image img-fluid" alt="Infant Care Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Infant Care Equipments</h5>
            <p>We at Narang are aware of how important quality and efficiency...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="infant-care-baby-care-equipments/index.php">Infant Care Equipments</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/laryngoscope-set-spares.jpg') }}" class="image img-fluid" alt="Laryngoscope Set">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Laryngoscope Set</h5>
            <p>Laryngoscope is a medical device that is used to obtain...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="laryngoscope-set-spares/index.php">Laryngoscope Set</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/cold-chain-equipments.jpg') }}" class="image img-fluid" alt="Cold Chain Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Cold Chain Equipments</h5>
            <p>An unbroken cold chain is vital in storage and distribution...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="cold-chain-equipments/index.php">Cold Chain Equipments</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/emergency-medical-products-supplies.jpg') }}" class="image img-fluid" alt="Emergency Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Emergency Products</h5>
            <p>Emergency Medical Products &amp; Supplies- Trust NET brand for...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="emergency-medical-products-supplies/index.php">Emergency Products</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/misc-surgical-medical-products.jpg') }}" class="image img-fluid" alt="Miscellaneous Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Miscellaneous Products</h5>
            <p>This category contains some of the utilitarian products...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="misc-surgical-medical-products/index.php">Miscellaneous Products</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/hospital-scrubs-linens-manufacturers.jpg') }}" class="image img-fluid" alt="Scrubs &amp; Linens">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Scrubs &amp; Linens</h5>
            <p>Almost all patient care personnel at Hospitals wear some form...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="hospital-scrubs-linens-manufacturers/index.php">Scrubs &amp; Linens</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/operation-theatre-tables.jpg') }}" loading="lazy" class="image img-fluid" alt="OT Tables">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>OT Tables</h5>
            <p>Narang Medical manufactures comprehensive range of Operating...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="operation-theatre-tables/index.php">OT Tables</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/rehabilitation-products-aids.jpg') }}" loading="lazy" class="image img-fluid" alt="Rehabilitation Aids">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Rehabilitation Products &amp; Aids</h5>
            <p>The most important feature of any Rehabilitation Aid is its...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="rehabilitation-products-aids/index.php">Rehabilitation Aids</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/clinical.jpg') }}" loading="lazy" class="image img-fluid" alt="Clinical Lab Devices">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Clinical Lab Devices</h5>
            <p>The most important feature of any Rehabilitation Aid is its...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        ...
        <div class="products-text-area">
        <p><a href="laboratory-products/clinical-lab-devices/index.php">Clinical Lab Devices</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/dental-equipments-products.jpg') }}" loading="lazy" class="image img-fluid" alt="Dental Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Dental Equipments</h5>
            <p>Dental instruments are the tools that dentists use to provide...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="dental-equipments-products/index.php">Dental Equipments</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/blood-collection-tubes.jpg') }}" loading="lazy" class="image img-fluid" alt="Blood Collection Tubes">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Blood Collection Tubes</h5>
            <p>We supply and export consistently high class Blood Collection...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="blood-collection-tubes/index.php">Blood Collection Tubes</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/medical-imaging.jpg') }}" loading="lazy" class="image img-fluid" alt="Medical Imaging Equipment">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Medical Imaging Equipment</h5>
            <p>It is the procedure used to create images...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="medical-imaging/index.php">Medical Imaging</a></p>
        </div>
    </div>
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/icu-equipment.jpg') }}" loading="lazy" class="image img-fluid" alt="ICU Equipment">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>ICU Equipment</h5>
            <p>Equipment used in the ICU varies from the general, such as...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="icu-equipments/index.php">ICU Equipment</a></p>
        </div>
    </div>
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/ot-equipment.jpg') }}" loading="lazy" class="image img-fluid" alt="OT Equipment">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>OT Equipment</h5>
            <p>Narang Medical Limited offers a wide range for operation theatre...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="ot-equipments/index.php">OT Equipment</a></p>
        </div>
    </div>
   ...
   <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        ...
        <img src="{{ asset('public/frontend/images/thumbnails/medical-freezers-refrigerators.jpg') }}" loading="lazy" class="image img-fluid" alt="Medical Refrigerators &amp; Freezers">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Medical Refrigerators &amp; Freezers</h5>
            <p>Narang Medical Limited offers a wide range for Freezers...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="medical-freezers-refrigerators/index.php">Medical Refrigerators</a></p>
        </div>
    </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        <div class="portfolio-item-new">
        <a href="blood-bank-equipments/index.php">
        <img src="{{ asset('public/frontend/images/thumbnails/blood-bank-equipments.jpg') }}" loading="lazy" class="image img-fluid" alt="Blood Bank Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Blood Bank Equipments</h5>
            <p>Narang Medical Limited offers a wide range for Blood Bank Equipments...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="blood-bank-equipments/index.php">Blood Bank Equipments</a></p>
        </div>
    </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        <div class="portfolio-item-new">
        <a href="physiotherapy-equipments/index.php">
        <img src="{{ asset('public/frontend/images/thumbnails/physiotherapy-equipments.jpg') }}" loading="lazy" class="image img-fluid" alt="Physiotherapy Equipments">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Physiotherapy Equipment</h5>
            <p>Narang Medical manufactures comprehensive range of Physiotherapy..</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="physiotherapy-equipments/index.php">Physiotherapy Equipment</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        <div class="portfolio-item-new">
        <a href="emergency-medical-products-supplies/covid-19/index.php">
        <img src="{{ asset('public/frontend/images/thumbnails/covid-19.jpg') }}" class="image img-fluid" alt="Covid-19 Products">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Covid-19 Products</h5>
            <p>In our endeavor to contain and restrict the widespread of...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="emergency-medical-products-supplies/covid-19/index.php">Covid-19 Products</a></p>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mr-btn-45">
        <div class="portfolio-item-new">
        <a href="misc-surgical-medical-products/oxygen-concentrators/index.php">
        <img src="{{ asset('public/frontend/images/thumbnails/oxygen-concentrators.jpg') }}" class="image img-fluid" alt="Oxygen Devices">
            <div class="overlay-portfolio">
            <div class="text">
            <h5>Oxygen Devices</h5>
            <p>Narang Medical Limited offers a wide range for Oxygen Devices...</p>
            <p class="mt-2"><strong>MORE...</strong></p>
            </div>
            </div>
        </a>
        ...
        <div class="products-text-area">
        <p><a href="misc-surgical-medical-products/oxygen-concentrators/index.php">Oxygen Devices</a></p>
        </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="testi_slider owl-carousel">
          ...
          <div class="testi_item">
            <!--<div class="profile-circle"><img src="/images/client-3.png" alt="Narang Reviews"></div>-->
            <div class="wow fadeIn" data-wow-duration="1s">
              <p>We've come to rely on this supplier for their outstanding customer support and consistent, prompt delivery of medical disposables, ensuring that our healthcare services maintain the highest standards of quality.'
It was great experience working with NML</p>
              <p style="font-size:13px;"><em>- Monu Kumar</em></p>
            </div>
          </div>
        </div>
          ...
          <div class="testi_item">
            ...
            <div class="wow fadeIn" data-wow-duration="1s">
              <p>Surgeons appreciate the user-friendly features and impeccable craftsmanship of Narang Medical's Trauma Implants, streamlining orthopedic procedures with confidence.</p>
              <p style="font-size:13px;"><em>- SG</em></p>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          <div class="testi_item">
            <!--<div class="profile-circle"><img src="/images/client-4.png" alt="Narang Reviews"></div>-->
            <div class="wow fadeIn" data-wow-duration="1s">
              <p>We've come to rely on this supplier for their outstanding customer support and consistent, prompt delivery of medical disposables, ensuring that our healthcare services maintain the highest standards of quality.' It was great experience working with NML</p>
              <p style="font-size:13px;"><em>- Monu Kumar</em></p>
            </div>
          </div>
        </div>
        <div class="item">
          <div class="testi_item">
            <!--<div class="profile-circle"><img src="/images/client-2.png" alt="Narang Reviews"></div>-->
            <div class="wow fadeIn" data-wow-duration="1s">
              <p>We are very happy with their range of medical equipment & supplies including medical disposables, hospital medical furniture, rehabilitation products, their products are superior and high end when it comes to quality.
Good luck to their entire manufacturing team!!!</p>
              <p style="font-size:13px;"><em>- Ishwinderpal Singh</em></p>
            </div>
          </div>
        </div>
      ...
      <div class="row testi-btn">
        <a href="/testimonials.php" class="btn-narang-outline" style="margin:0 auto;">Read More</a>
      </div>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="tile">
                        <div class="banner-img">
                            <img src="{{ asset('public/frontend/images/events/africa-health.jpg') }}" alt="Africa Health Exhibition 2024 Narang Medical Exhibitions">
                        </div>
                        <div class="tile-box">
                          <h6>Africa Health Exhibition 2024</h6>
                         <p>
                             Booth: H2.D10<br>
                             22<sup>nd</sup> to 24<sup>th</sup> Oct. 2024<br>
                          Cape Town International Convention Centre, South Africa</p>
                        </div>
                        <div class="tile-box2">
                        <p><a href="https://www.narang.com/domore/index.php"><i class="far fa-calendar-check"></i> Fix Appointment</a></p>
                        </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="tile">
                        <div class="banner-img">
                            <img src="{{ asset('public/frontend/images/events/medica.jpg') }}" alt="Medica 2024 Narang Medical Exhibitions">
                        </div>
                        <div class="tile-box">
                          <h6>MEDICA 2024</h6>
                         <p>11<sup>th</sup> to 14<sup>th</sup> Nov. 2024<br>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="tile">
                        <div class="banner-img">
                            <img src="{{ asset('public/frontend/images/events/arab-health.jpg') }}" alt="Arab Health 2025 Narang Medical Exhibitions">
                        </div>
                        <div class="tile-box">
                          <h6>Arab Health 2025</h6>
                         <p>27<sup>th</sup> to 30<sup>th</sup> Jan. 2025<br>
                            on Concourse Near Ibis Hotel, Dubai World Trade Centre, Dubai, UAE.</p>
                        </div>
                        <div class="tile-box2">
                        <p><a href="https://www.narang.com/domore/index.php"><i class="far fa-calendar-check"></i> Fix Appointment</a></p>
                        </div>
        ...
        <div class="tile">
        <div class="banner-img">
        <img src="{{ asset('public/frontend/images/events/distributor.jpg') }}" loading="lazy" alt="Become Our Distributor">
        </div>
        <div class="tile-box">
        <h6>Become Our Distributor</h6>
        <p>Let's profit together!<br />
        We are looking for distributors in your area.</p>
        </div>
        <div class="tile-box2">
        <p><a href="/distributorship-enquiry-form.php"><i class="fas fa-edit"></i> Apply Here</a></p>
        </div>
        </div>
            </div>
        ...
        <a href="/nml-exhibitions.php" class="btn-narang-outline" style="margin:0 auto;">View All Exhibitions</a>
      </div>
    </div>
...
<img src="images/foundation-day-2022.jpg" style="width:100%">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 footers-tag">
            <h1 class="footers-tag-text">Hospital Supplies</h1>
            <h2 class="footers-tag-text">Medical Equipment</h2>
            <h3 class="footers-tag-text">Hospital Medical Supplies</h3>
            <h4 class="footers-tag-text">Manufacturer Suppliers</h4>
            <h6 class="footers-tag-text">
              <a href="net-brand/index.php">NET Brand</a>
            </h6>
          </div>
        </div>
      </div>
