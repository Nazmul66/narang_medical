...
<title>Distributors Wanted | Become Our Distributor | Narang Medical Limited | Medical Devices | Medical Equipment Company</title>

<meta name="description" content="Distributors Wanted - Become Our Distributor. Narang Medical Limited is leading manufacturer and suppliers of Medical Devices, Medical Equipment and Hospital Supplies that includes Hospital Furniture, Orthopaedic Implants, Surgical Instruments, Disposables and more .... medical device distributor, medical equipment distributor, medical distributors, dealers, sales, agents"/>
<meta name="keywords" content="Distributors Wanted, Become Our Distributor, medical device distributor, medical equipment distributor, medical distributors, dealers, Distributor Opportunities, Franchise, agents, Narang Medical, Narang Medical Limited, India, NET, narang, narang.com" />
<meta name="abstract" content="Wanted distributors for medical device company "/>
...
<script language="JavaScript" src="js/form_validator.js"></script>
...
.iframeContact{ width: 100%; height: 1750px;}

@media only screen and (max-width: 600px) {
  .iframeContact{ width: 100%; height: 1710px;}
}
...
<header id="header">
    ...
    <div class="wsmainwp clearfix">
      ...
      <nav class="wsmenu clearfix">
        ...
        <script async src="https://cse.google.com/cse.js?cx=partner-pub-4125706398982027:iihuzhchvw4"></script>
          ...
          <li aria-haspopup="true"><a href="/index.php" class="menuhomeicon"><i class="fas fa-home"></i><span class="hometext">
                HOME</span></a></li>
          <li><a href="/about-us.php" class="menuhomeicon">ABOUT</a></li>
          ...
          <li><a href="/quality.php" class="menuhomeicon">QUALITY</a></li>
          <li><a href="/pricing.php" class="menuhomeicon">PRICING</a></li>
          ...
          <li aria-haspopup="true"><span class="wsmenu-click"><i class="wsmenu-arrow"></i></span><a href="#">CONTACT <span class="wsarrow"></span></a>
            <ul class="sub-menu">
              ...
              <li aria-haspopup="true"><a href="/feedback/index.php">Feedback</a></li>
  ...
  Breadcrumb Section
  ============================-->
    <div class="breadcrumb-image" style="background-image: url(images/banner/product.jpg);">
  ...
  <section class="pt-80"  style="background:#ebeaea;">
    ...
    <!--Form with header-->
        ...
        <iframe id="gform" src="https://docs.google.com/forms/d/e/1FAIpQLSfB6Ntn2IgG8BG4nIf3ubQspNAcBxwN7mdnErjGdFcvbhKhKQ/viewform?embedded=true" class="iframeContact"  frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
...
It was great experience working with NML</p>
        ...
        <div class="item">
          <div class="testi_item">
            <!--<div class="profile-circle"><- src="/images/client-4.png" alt="Narang Reviews"></div>-->
            <div class="wow fadeIn" data-wow-duration="1s">
...
<section>
      <div class="container-fluid">
        ...
        <h1 class="footers-tag-text">Distributorship Enquiry Form</h1>
        <h2 class="footers-tag-text">Medical Equipment Dealership</h2>
        <h3 class="footers-tag-text">Medical Supply Distributorship</h3>
        <h4 class="footers-tag-text">Medical Device Franchise</h4>
          </div>
        </div>
      </div>
</section>
...
var a_fields = {
	'name': {
		...
		't': '_name',// id of the element to highlight if input not validated

		'm': null,     // must match specified form field
		'mn': 2,       // minimum length
		'mx': 10       // maximum length
	},
	'name':{'l':'Name','r':true,'f':'alpha','t':'_name'},

				'phone':{'l':'Phone','r':true,'f':'alphanum','t':'_phone'},


	'country':{'l':'Country','f': 'alpha','t':'_country'},
	'yourcomments':{'l':'Your Comments','f': 'yourcomments','t':'_yourcomments'},
	'email':{'l':'E-mail','r':true,'f':'email','t':'_email'},
	'company':{'l':'Company Name','r':true,'f':'alpha','t':'_company'},
	'address':{'l':'Full Mailing Address','r':true,'f':'alpha','t':'_address'},
...
var v = new validator('quotation', a_fields, o_config);
