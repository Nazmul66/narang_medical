...
<title>Pricing - Narang Medical Ltd.</title>
...
<div class="sharethis-inline-share-buttons"></div>
  	<!-- Google Tag -->
    <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-B3NV"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-B3NV');</script>
...
<section>
      <div class="container-fluid">
        ...
        <h1 class="footers-tag-text">Pricing</h1>
        <h2 class="footers-tag-text">Suppliers</h2>
        <h3 class="footers-tag-text">Surgical Instruments</h3>
        <h4 class="footers-tag-text">Medical Supplies</h4>
          </div>
        </div>
      </div>
</section>
