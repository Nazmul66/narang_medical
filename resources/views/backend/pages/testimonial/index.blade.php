                ...
                <form id="createForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div>
                            ...
                            <textarea class="form-control" name="description" id="description" rows="5" placeholder="Write description....."></textarea>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="col mb-3">
                        <label for="up_title" class="form-label">Testimonial Title</label>
                        <input type="text" id="up_title" name="title" class="form-control" placeholder="Testimonial Title">
                    </div>

                    <div>
                        <label for="up_description" class="form-label">Description</label>
                        <textarea class="form-control" name="description" id="up_description" rows="5" placeholder="Write description....."></textarea>
                    </div>
