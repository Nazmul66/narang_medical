...
@push('meta-title')
        Dashboard | Product SubCategory Section
@endpush
 ...
 <div class="row">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Product SubCategory Table</h5>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create_Modal">Add Product SubCategory</button>
        </div>


        <div class="card-body">
          <div class="table-responsive text-nowrap">
            <table class="table table-bordered" id="productSubCategoryTables">
              <thead>
                <tr>
                  <th>#SL.</th>
    ...
    <div class="modal fade" id="create_Modal" tabindex="-1" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel3">Create New Product SubCategory</h5>
            ...
            <div class="modal-body">
                <form id="createForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="title" class="form-label">Product SubCategory Title</label>
                                <input type="text" id="title" name="title" class="form-control" placeholder="Product SubCategory Title">
                            </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel3">Update Product SubCategory</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                ...
                <form id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="up_title" name="title" class="form-control" placeholder="Product Category Title">
                        </div>
...
@push('custom-script')
 ...
 <script>
     ...
     $(document).ready(function(){
        ...
        // show all data
        let productSubCategoryTables = $('#productSubCategoryTables').DataTable({
            order: [
                [0, 'asc']
            ],
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.get-product-subCategory') }}",
            // pageLength: 30,
        ...
        $(document).on('click', '#status', function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.product-subCategory.status') }}",
                data: {
                    // '_token': token,
                    id: id,
                    status: status
                ...
                success: function (res) {
                    productSubCategoryTables.ajax.reload();
        ...
        $(document).on("click", '#editButton', function (e) {
            ...
            $.ajax({
                ...
                //     'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                // },
                url: "{{ url('admin/product-subCategory') }}/" + id + "/edit",
                processData: false,  // Prevent jQuery from processing the data
                contentType: false,  // Prevent jQuery from setting contentType
                success: function (res) {
        ...
        $("#updateForm").submit(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ url('admin/product-subCategory') }}/" + id,
                data: formData,
                processData: false,  // Prevent jQuery from processing the data
                contentType: false,  // Prevent jQuery from setting contentType
                success: function (res) {
